...
|---|---|---|---|---|---|
| A1 Spotlight Curated Rail | 3 | 1 | Fill-In | Now | It bypasses the algorithm she has outgrown and ships in days, but it drives play without search, so it barely moves the primary metric. |
...
| A6 Spotlight Digest Email | 1 | 2 | Fill-In | Cut | She's already a heavy user, and an email does nothing for in-app search-then-play. |
| A7 Curator Profiles | 3 | 4 | Time Sinker | Later | Human taste suits someone who has outgrown the algorithm, but the follow graph, profile pages and curator supply are too much for 2 engineers in 3 weeks. |
...
## Roadmap
### NOW, 3-week sprint
- **A1 Spotlight Curated Rail**, It bypasses the algorithm she has outgrown and ships in days, but it drives play without search, so it barely moves the primary metric.
...
[streamline-spotlight-roadmap.html](https://github.com/user-attachments/files/32609744/streamline-spotlight-roadmap.html)
